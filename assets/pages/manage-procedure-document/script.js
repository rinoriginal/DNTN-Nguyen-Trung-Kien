var DFT = function ($) {
    ...
    function handleEventClickDeletePromotions(e) {
        ...
        swal({
            ...
            console.log({ ok });
            if (ok === true) {
                _AjaxData('/manage-procedure-document/' + id, 'DELETE', {}, (resp) => {
                    console.log({ resp })
                    var title = '';
                    var message = '';
                    var type = '';
    ...
    var queryFilter = function (page) {
        ...
        _Ajax("/manage-procedure-document?" + $.param(filter), 'GET', {}, function (resp) {
console.log({resp});
    ...
    var loadData = function (resp) {
        ...
        resp.data.forEach(function (el) {
            ...
            var action = resp.isRoleAgent ?
             ( `<a role="button" href="/#manage-procedure-document/${el._id}" class="p-t-3 btn-flat-bg btn-edit" data-original-title="Chi tiết"><i class="zmdi zmdi-eye text-primary f-18" style="color:#4da6ff"></i></a>`)
             : ( `<a role="button" href="/#manage-procedure-document/${el._id}/edit" class=" btn-flat-bg btn-edit"  data-original-title="Sửa"><i class="zmdi zmdi-edit text-info f-19" style="color:#4da6ff"></i></a>
