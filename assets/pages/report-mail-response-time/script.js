var DFT = function ($) {
    ...
    var bindClick = function () {
        ...
        $('#exportexcel').on('click', function (event) {
            ...
            $(this).attr('download', todaysDate + '_Báo cáo mail - Báo cáo thời gian phản hồi.xls')
    ...
    var cascade = function(){
        $('select[name="idCompany"]').on('change', function () {
            $.get('/report-mail-response-time', {idParent: $(this).val()}, function (res) {
    ...
    var bindTextValue = function () {
        _.each(_.allKeys(_config.MESSAGE.REPORT_MAIL_RESPONSE_TIME), function (item) {
            $('.' + item).html(_config.MESSAGE.REPORT_MAIL_RESPONSE_TIME[item]);
        });
    }
