var DFT = function ($) {
    ...
    var bindClick = function () {
        ...
        $('#exportexcel').on('click', function (event) {
            ...
            $(this).attr('download', todaysDate + '_Báo cáo chat - Báo cáo theo tình trạng.xls')
    ...
    var cascade = function(){
        $('select[name="idCompany"]').on('change', function () {
            $.get('/report-mail-by-status', {idParent: $(this).val()}, function (res) {
    ...
    var bindTextValue = function () {
        _.each(_.allKeys(_config.MESSAGE.REPORT_MAIL_BY_STATUS), function (item) {
            $('.' + item).html(_config.MESSAGE.REPORT_MAIL_BY_STATUS[item]);
        });
    }
