...
var DFT = function ($) {
  ...
  $('.zmdi-refresh').bind('click', function () {
    _.LoadPage(location.hash = "report-statistical-conversation-by-month");
  });

  // Hiển thị tên cột theo file config
  var bindTextValue = function () {
    _.each(_.allKeys(_config.MESSAGE.REPORT_STATISTICAL_CONVERTSATION_BY_MONTH), function (item) {
      $('.' + item).html(_config.MESSAGE.REPORT_STATISTICAL_CONVERTSATION_BY_MONTH[item]);
    });
  }
