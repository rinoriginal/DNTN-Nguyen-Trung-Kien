            ...
            onValidationComplete: function (form, status) {
                ...
                if (status) {
                    ...
                    if (cont) {
                        ...
                        _data.append('fnTextAreaEncode', window.btoa(encodeURIComponent(_jdata.fnTextArea))); //encode base64
                        _AjaxData('/kpi-mark-content?collection=' + collection, 'POST', _data, function (resp) {
    ...
    return {
        init: function () {
            $.validationEngineLanguage.allRules['FieldCheck'] = {
                "url": "/kpi-mark-content/validate?collection=" + window.location.obj.collection,
        ...
        uncut: function () {
            ...
            $('#fnTextArea').bind('input propertychange');
        }
    };
}(jQuery);