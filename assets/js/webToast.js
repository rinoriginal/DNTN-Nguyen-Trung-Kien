...
const LoadingToast=function(options){
  ...
  align=(options.align? (options.align).toLowerCase():'topright' );
  let htmlString = '<div> '+topLineProgress+'<div class="toastContainer toast'+align+'" ><div  class="webToast">'+ 
  '<div class="toastContent">' +
  '<div class="image-cover-phone">'+
  '<img src="assets/images/phone-incoming.png" alt="Italian Trulli" class="phone-incoming">' + 
  '</div>'+
  '<div class="info-call">'+
  '<p class="toastStatus">'+ 'Incoming Call ' +'</p>' +
  '</div>'+
  '</div>'+'<button type="button" style="background-color: #28a745 !important;border-color: #28a745 "class="btn btn-primary btn-lg btn-block" id="answerCallInbound" > Answer </button>' +'</div></div>' + 
  '</div>';
