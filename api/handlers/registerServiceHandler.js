...
const stringChatMiss = "O{bTyp | S{WCS-STD}bUsr | S{system}bUid | I{-1}sCmd | S{}sId | A{}sNme | S{}sUrl | S{}sLbl | S{}sCok | S{}mMsg | S{Chat has been initiated by customer.}fAct | S{}fTyp | S{}fKey | S{}fVal | S{}bUserType | S{SYSTEM}transType | S{}mTsp | S{2023-12-26 01:58:57}mDeptId | S{999}bPvtMsg | S{1}bToPvt | S{null}mOffRecord | S{null}mMid | S{}entityName | S{null}}|O{bTyp | S{WCS-STD}bUsr | S{system}bUid | S{1088}sCmd | S{agentPickup}sId | A{}sNme | S{}sUrl | S{}sLbl | S{}sCok | S{}mMsg | S{You are now chatting with ggg agent11}fAct | S{}fTyp | S{}fKey | S{}fVal | S{}bUserType | S{SYSTEM}transType | S{}mTsp | S{2023-12-26 01:59:00}bPvtMsg | S{0}bToPvt | S{}mMid | I{1}mDeptId | S{999}agentName | S{ggg agent11}vchatCapable | I{1}vchatCapable | I{1}|O{bTyp | S{WCS-STD}bUsr | S{ggg agent11}bUid | S{1088}sCmd | S{}sId | A{}sNme | S{}sUrl | S{}sLbl | S{}sCok | S{}mMsg | S{dsg}fAct | S{}fTyp | S{}fKey | S{}fVal | S{}bUserType | S{AGENT}transType | S{}mTsp | S{2023-12-26 01:59:02}bPvtMsg | I{0}bToPvt | S{all}mMid | I{3}mDeptId | S{999}mDeptId | S{999}|O{bTyp | S{EGLV-EXIT}bUsr | S{ggg agent11}bUid | S{1088}bUserType | S{SYSTEM}bXTyp | I{1}mMsg | S{ggg agent11 has ended the chat}mDeptId | S{999}mTsp | S{2023-12-26 01:59:03}mMid | I{4}mMid | I{4}"
