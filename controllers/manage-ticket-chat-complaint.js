exports.index = {
        ...
        _async.waterfall([
            ...
            _TicketComplaint.aggregatePaginate(_TicketComplaint.aggregate(rs), { page: page, limit: rows }, function (error, results, node, count) {
                ...
                var paginator = new pagination.SearchPaginator({
                    prelink: '/manage-ticket-chat-complaint',
                    current: page,
                    rowsPerPage: rows,
                    totalResult: count
                });
    ...
    html: function (req, res) {
        ...
        _async.parallel({
            ...
            _.render(req, res, 'manage-ticket-chat-complaint', {
...
exports.edit = function (req, res) {
    ...
    let _idTicket = _.convertObjectId(req.params.manageticketchatcomplaint)
...
exports.update = function (req, res) {
    ...
    if (_.has(req.body, 'files') && req.body.files.length > 0) {
        ...
        _TicketComplaint.findByIdAndUpdate(
            req.params['manageticketchatcomplaint'],
            {
                $push: {
                    feedbacks: {
        ...
        _TicketComplaint.findByIdAndUpdate(req.params['manageticketchatcomplaint']
            , {
                $push: {
                    feedbacks: {
                        author: new mongodb.ObjectId(req.session.user._id),
