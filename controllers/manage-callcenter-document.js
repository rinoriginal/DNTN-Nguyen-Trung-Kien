exports.index = {
    json: function (req, res) {
        ...
        agg._pipeline.push({ $match: { type: 3 } }) //tài liệu call center
        ...
        _Document.aggregatePaginate(agg, { page: page, limit: rows }, function (error, results, node, count) {
            ...
            var paginator = new pagination.SearchPaginator({
                prelink: '/manage-callcenter-document',
                current: page,
                rowsPerPage: rows,
                totalResult: count
            });
    ...
    html: function (req, res) {
        ...
        _Document.aggregatePaginate(agg, { page: page, limit: rows }, function (error, results, node, count) {
            ...
            _.render(req, res, 'manage-callcenter-document', {
                title: 'Quản lý tài liệu Callcenter',
                data: results,
                isRoleAgent,
...
exports.new = function (req, res) {
    _.render(req, res, 'callcenter-document-new', {
...
exports.create = function (req, res) {
    ...
    _body.type = 3//tài liệu call center
    ...
    _async.waterfall([
        ...
        res.json({ code: (error ? 500 : 200), message: error ? error.message : 'Tạo mới tài liệu Callcenter thành công!' });
    });
};


exports.edit = function (req, res) {
    _Document.findById(req.params['managecallcenterdocument'], function (err, results) {
        _.render(req, res, 'callcenter-document-edit', {
...
exports.update = function (req, res) {
    ...
    _async.waterfall([
        ...
        function (r, callback) {
            _Document.findByIdAndUpdate(req.params.managecallcenterdocument, { $set: _body }, callback);
        }
    ], function (error, result) {
...
exports.destroy = function (req, res) {
    var id = req.params.managecallcenterdocument;
...
exports.show = function (req, res) {
    _Document.findById(_.convertObjectId(req.params.managecallcenterdocument), (err, results) => {
        _.render(req, res, 'callcenter-document-show', {
