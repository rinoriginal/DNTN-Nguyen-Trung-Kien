...
exports.index = function (req, res) {
    ...
    _async.waterfall([
        ...
        _results.forEach(e => { if (e.mail_type == 2) e["forward"] = "<button id='forwardMailBtn' data-mail='" + e["_id"] + "' class='btn btn-primary waves-effect' onclick=" + "setValueTrueF('" + (String(e["_id"])) + "" + "')" + "><i class='fa fa-forward'></i></button>" })
