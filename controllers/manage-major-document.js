exports.index = {
    json: function (req, res) {
        ...
        agg._pipeline.push({ $match: { type: 2 } }) //tài liệu nghiệp vụ
    ...
    html: function (req, res) {
        ...
        _Document.aggregatePaginate(agg, { page: page, limit: rows }, function (error, results, node, count) {
            ...
            _.render(req, res, 'manage-major-document', {
                title: 'Quản lý tài liệu nghiệp vụ',
                data: results,
                isRoleAgent,
...
exports.new = function (req, res) {
    _.render(req, res, 'major-document-new', {
...
exports.create = function (req, res) {
    ...
    _body.type = 2//tài liệu nghiệp vụ
    ...
    _async.waterfall([
        ...
        res.json({ code: (error ? 500 : 200), message: error ? error.message : 'Tạo mới tài liệu nghiệp vụ thành công!' });
    });
};


exports.edit = function (req, res) {
    _Document.findById(req.params['managemajordocument'], function (err, results) {
        _.render(req, res, 'major-document-edit', {
...
exports.update = function (req, res) {
    ...
    _async.waterfall([
        ...
        function (r, callback) {
            _Document.findByIdAndUpdate(req.params.managemajordocument, { $set: _body }, callback);
        }
    ], function (error, result) {
...
exports.destroy = function (req, res) {
    var id = req.params.managemajordocument;
...
exports.show = function (req, res) {
    _Document.findById(_.convertObjectId(req.params.managemajordocument), (err, results) => {
        _.render(req, res, 'major-document-show', {
